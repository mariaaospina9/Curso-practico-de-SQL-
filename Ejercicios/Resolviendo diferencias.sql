-- Nnúmero de alumnos por carrera mostrando id de carrera
SELECT carrera_id,
  COUNT(*) AS cuenta
FROM platzi.alumnos
GROUP BY carrera_id
...
-- Alumnos cuya carrera no existe
...
-- Alumnos y carreras, incluyendo alumnos sin carrera y carreras sin alumnos
SELECT a.nombre, a.apellido, a.carrera_id, c.id, c.carrera
FROM platzi.alumnos AS a
